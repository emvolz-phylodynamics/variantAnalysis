## adapted from treeio package, https://github.com/YuLab-SMU/treeio v 1.15.4
## modified to remove casting to numeric 
...
read.stats_beast_internal <- function(beast, tree) {
	...
	# new:
        ...
        #}
	res[ seq_along(name) ] <- val[ seq_along(name) ] 
